...
function App() {
  ...
  const translations = {
    ar: {
      ...
      aboutText1: 'إخوان العلم هي ورشة رائدة في مجال الألمنيوم ملتزمة بتقديم جودة استثنائية وحرفية عالية. مع سنوات من الخبرة في هذا المجال، نحن متخصصون في إنشاء حلول الألمنيوم المخصصة للمشاريع السكنية والتجارية والصناعية.',
      ...
      footerText: '© 2025 ورشة إخوان العلم للألمنيوم. جميع الحقوق محفوظة.',
      ...
      <nav className="navbar">
        <div className="nav-container">
          <div className="logo">
            ...
            <span className="logo-text">{language === 'ar' ? 'إخوان العلم' : 'ALAM BROS'}</span>
          </div>
